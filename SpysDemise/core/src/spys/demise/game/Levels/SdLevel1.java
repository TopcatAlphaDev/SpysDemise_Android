 ...
 */
public class SdLevel1 extends SdLevel {
    ...
    public Array<spys.demise.game.Items.SdItemParameters> GetGameItemParameters() {
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition5, spys.demise.game.Items.SdItemCamera.class));
