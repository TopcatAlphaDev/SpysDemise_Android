 ...
 */
public class SdLevel11 extends SdLevel {
    ...
    @Override
    public String GetBackgroundImageFile() { return  "Screens/SdBackground3.jpg"; }

    @Override
    public SdLevel GetNextLevel() {
        return new SdLevel12();
    }
    ...
    public Array<spys.demise.game.Items.SdItemParameters> GetGameItemParameters() {
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition3, spys.demise.game.Items.SdItemTeleport.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(324,FloorYPosition5, spys.demise.game.Items.SdItemHeart.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition7, spys.demise.game.Items.SdItemMoney.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition9, spys.demise.game.Items.SdItemGun.class));
        return Parameters;
    }

    @Override
    public String GetLevelStartText() {
        return "Unpredictable teleportation.";
    }
