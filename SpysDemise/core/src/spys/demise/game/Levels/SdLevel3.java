 ...
 */
public class SdLevel3 extends SdLevel {
    ...
    public Array<spys.demise.game.Items.SdItemParameters> GetGameItemParameters() {
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition3, spys.demise.game.Items.SdItemCamera.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition4, spys.demise.game.Items.SdItemMoney.class));
