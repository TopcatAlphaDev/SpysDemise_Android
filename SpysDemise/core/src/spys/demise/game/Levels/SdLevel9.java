 ...
 */
public class SdLevel9 extends SdLevel {
    ...
    public Array<spys.demise.game.Items.SdItemParameters> GetGameItemParameters() {
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(354,FloorYPosition3, spys.demise.game.Items.SdItemArrowDown.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(324,FloorYPosition5, spys.demise.game.Items.SdItemGun.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(150,FloorYPosition7, spys.demise.game.Items.SdItemArrowDown.class));
