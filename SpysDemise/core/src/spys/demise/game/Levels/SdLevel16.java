 ...
 */
public class SdLevel16 extends SdLevel {
    ...
    public Array<spys.demise.game.Items.SdItemParameters> GetGameItemParameters() {
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(105,FloorYPosition2, spys.demise.game.Items.SdItemShoeSlow.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(412,FloorYPosition2, spys.demise.game.Items.SdItemCape.class));
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition4, spys.demise.game.Items.SdItemArrowUp.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition6, spys.demise.game.Items.SdItemShoeFast.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(470,FloorYPosition8, spys.demise.game.Items.SdItemArrowDown.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(45,FloorYPosition8, spys.demise.game.Items.SdItemDocument.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(320,FloorYPosition10, spys.demise.game.Items.SdItemShoeSlow.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(65,FloorYPosition10, spys.demise.game.Items.SdItemHeart.class));
        return Parameters;
    }
