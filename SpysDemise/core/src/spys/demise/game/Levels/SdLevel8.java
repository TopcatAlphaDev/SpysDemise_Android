 ...
 */
public class SdLevel8 extends SdLevel {
    ...
    public Array<spys.demise.game.Items.SdItemParameters> GetGameItemParameters() {
        ...
        Parameters.add(new spys.demise.game.Items.SdItemParameters(54,FloorYPosition3, spys.demise.game.Items.SdItemArrowUp.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(324,FloorYPosition5, spys.demise.game.Items.SdItemDocument.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(350,FloorYPosition7, spys.demise.game.Items.SdItemArrowUp.class));
        Parameters.add(new spys.demise.game.Items.SdItemParameters(GetRandomPosition(),FloorYPosition9, spys.demise.game.Items.SdItemKey.class));
        return Parameters;
    }
